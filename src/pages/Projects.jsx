  ...
  const projectData = [
    {
      ...
      description:
        "A sophisticated React component featuring 3D perspective transforms and smooth animations. This project demonstrates advanced CSS transforms, mouse tracking, and responsive design principles to create an engaging user interface.",
      detailedDescription:
      ...
      challenges:
        "Implementing smooth performance while maintaining 60fps animations across all devices",
      learnings:
        "Advanced CSS transforms, React performance optimization, and responsive design patterns",
      images: [
    ...
    },
    {
      ...
      description:
        "A comprehensive web application built with React and modern design principles, featuring responsive layouts, smooth animations, and intuitive user interactions.",
      detailedDescription:
      ...
      challenges:
        "Implementing real-time features while maintaining scalability and performance",
      learnings:
        "Full-stack development, real-time communications, and scalable architecture design",
      images: [
    ...
    },
    {
      ...
      description:
        "A mobile-first approach to application design featuring intuitive user interface patterns, smooth interactions, and seamless user experience across all devices.",
      detailedDescription:
      ...
      challenges:
        "Achieving native performance while maintaining code reusability across platforms",
      learnings:
        "Mobile development patterns, native bridge communications, and mobile UX principles",
      images: [
    ...
    },
    {
      ...
      description:
        "A comprehensive e-commerce platform with advanced shopping cart functionality, payment integration, and modern user experience design.",
      detailedDescription:
      ...
      challenges:
        "Building a scalable architecture that can handle high concurrent users and transactions",
      learnings:
        "E-commerce architecture, payment processing, database optimization, and cloud deployment",
      images: [
    ...
    },
    {
      ...
      description:
        "A creative portfolio showcase featuring stunning visual design, engaging user experience, and optimized performance across all devices.",
      detailedDescription:
        "This portfolio website represents a perfect blend of creativity and technical excellence. Built with cutting-edge web technologies, it features advanced animations, interactive elements, and a sophisticated content management system. The design focuses on showcasing creative work while maintaining fast loading times and excellent SEO performance.",
      category: "Design",
      technologies: [
        "Gatsby",
        "GraphQL",
      ...
      challenges:
        "Balancing creative animations with performance and maintaining fast loading speeds",
      learnings:
        "Advanced web animations, 3D web graphics, static site generation, and performance optimization",
      images: [
    ...
    },
    {
      ...
      challenges:
        "Processing and visualizing large datasets in real-time while maintaining smooth user interactions",
      learnings:
        "Data visualization techniques, real-time streaming, performance optimization for large datasets",
      images: [
        "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2000&auto=format&fit=crop",
    ...
    },
    {
      ...
      shortDescription:
        "Scalable API management with microservices architecture",
      description:
        "A robust API gateway built with microservices architecture, featuring load balancing, authentication, rate limiting, and service discovery for enterprise applications.",
      detailedDescription:
        "This enterprise-grade API Gateway serves as a central entry point for microservices architecture, handling routing, authentication, rate limiting, and load balancing. Built with Spring Boot and deployed on Kubernetes, it features service discovery, circuit breaker patterns, and comprehensive monitoring. The gateway supports REST and GraphQL APIs with real-time analytics and automated scaling.",
      category: "DevOps",
      technologies: [
        "Spring Boot",
        "Kubernetes",
      ...
      challenges:
        "Implementing fault-tolerant service communication and maintaining high availability across distributed services",
      learnings:
        "Microservices patterns, container orchestration, distributed systems design, and cloud-native architecture",
      images: [
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              {reorderedProjects.map((project, idx) => {
                ...
                const isLargeCard =
                  layout.height.includes("500px") || layout.height === "h-96";
                ...
                return (
                  ...
                  >
                        ...
                        <>
                          <div className="flex-1 relative overflow-hidden min-h-0">
                            ...
                            <div className="absolute top-4 left-4">
                              <span
                                className={`px-3 py-1.5 backdrop-blur-md rounded-full text-xs font-medium text-white ${
                            ...
                            <div className="absolute top-4 right-4">
                              <span
                                className={`px-3 py-1.5 backdrop-blur-md rounded-full text-xs font-medium ${
                    ...
                    {/* Hover Effect Border */}
                    <div
                      className={`absolute inset-0 rounded-xl sm:rounded-2xl ring-2 transition-all duration-300 pointer-events-none ${
                        project.category === "DevOps"
          ...
          {selectedProject !== null && (
            ...
            >
              ...
              <motion.div
                ...
                style={{
                  maxWidth: screenSize === "mobile" ? "100%" : "90vw",
                  maxHeight: "90vh",
                }}
                ...
                <div className="relative aspect-video bg-gray-100 dark:bg-gray-800">
                  <AnimatePresence mode="wait">
                    <motion.img
                      ...
                      src={
                        projectData[selectedProject].images[currentImageIndex]
                      }
                      alt={`${projectData[selectedProject].title} - Image ${
                        currentImageIndex + 1
                      }`}
                  ...
                  <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-2 sm:space-x-4">
                    {projectData[selectedProject].images.map((_, index) => (
                      <motion.button
                        ...
                        whileHover={{
                          scale: screenSize === "mobile" ? 1.3 : 1.5,
                        }}
                        whileTap={{ scale: 1.2 }}
                      >
                        {index === currentImageIndex && (
                ...
                <div className="p-4 sm:p-6 lg:p-8 xl:p-12 space-y-6 sm:space-y-8">
                  ...
                  >
                    <div className="flex flex-wrap gap-2">
                      ...
                      <span
                        className={`px-3 sm:px-4 py-1 sm:py-2 rounded-full text-sm font-medium ${
                          projectData[selectedProject].status === "Completed"
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {projectData[selectedProject].technologies.map(
                        (tech, index) => (
                          <span
                            key={index}
                  ...
                  >
                    ...
                    <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                      {projectData[selectedProject].features.map(
                        (feature, index) => (
                          <li
                            key={index}
