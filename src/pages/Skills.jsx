    ...
    <div className="overflow-hidden w-full max-w-[90rem] mx-auto py-12 relative">
      ...
      <div className="flex w-max animate-scroll-x">
        {[...skills, ...skills].map((skill, index) => (
          <div
            key={index}
            className={`w-64 h-56 mx-4 ${
              darkMode ? "bg-white text-black" : "bg-black text-white"
            } shadow-xl rounded-2xl p-5 flex flex-col justify-center items-center text-center group hover:scale-95 transition-all duration-300`}
          >
